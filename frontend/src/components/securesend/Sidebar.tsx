    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 px-4 py-4">
          ...
          {(!collapsed || (collapsed && typeof window !== "undefined" && window.innerWidth < 768)) && (
        ...
        <div className={cn("px-3 pb-3", collapsed && "md:px-2")}>
          <button
            ...
            className={cn(
              ...
              collapsed ? "md:h-12 md:w-12 md:justify-center h-14 w-full px-4" : "h-14 w-full px-4",
            )}
          >
            <Plus className="h-5 w-5 shrink-0" />
            {( !collapsed || (collapsed && window.innerWidth < 768)) && <span>New Secure Message</span>}
          </button>
        </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  collapsed && "md:justify-center md:pl-0 md:pr-0 md:py-3 md:rounded-full md:mx-auto md:w-12",
                  isActive
        ...
        <div className={cn("border-t border-border px-2 py-2", collapsed && "md:px-1")}>
          ...
          >
            ...
            {(!collapsed || (collapsed && window.innerWidth < 768)) && <span className="flex-1 text-left">Anonymous 🎭</span>}
          </Link>
          <button
          ...
          >
            ...
            {(!collapsed || (collapsed && window.innerWidth < 768)) && <span className="flex-1 text-left">Log out</span>}
          </button>
        </div>
      </aside>
    </>
